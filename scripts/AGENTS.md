...
wrappers for package-local dev, opensrc sync, and Node test files for those
helpers.
...
- Keep Alchemy-facing scripts aligned with the root `pnpm alchemy ...` command
  wrapper and the infrastructure guide.
